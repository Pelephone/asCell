package asSkinStyle.data
{
	 ...
	 */
	public class CssStyle extends StyleComposite
	{
		/**
		 * 引用分隔符
		 
		protected static const SEPARTOR_REFERENCE:String = "#";*/
		/**
		 * 引用属性
		 */
		protected static const ATTR_REFERENCE:String = "reference";
		/**
		 * className前缀字符
...
//		private var _ptName:String;
		 ...
		 */
		public function CssStyle(idName:String,cssVars:Object=null)
		{
