...
package asSkinStyle.draw
{
	...
	/** 组件重绘改变. **/
	[Event(name="component_draw", type="sparrowGui.view.draw.RectDraw")]

	/**
	 * 基本绘图容器，功能跟shape相同，只是继承的对象不同
	 * @author Pelephone
	 * @website http://cnblogs.com/pelephone
	 */
	public class SpriteDraw extends Sprite implements IDrawBase
	{
		/**
		 * 默认样式UI名
		 */
		private var defaultUIName:String;
		/**
		 * 组件重绘
		 */
		...
		protected var _width:Number = 5;
		protected var _height:Number = 5;
		
		public function SpriteDraw(uiName:String="draw")
		{
			super();
			defaultUIName = uiName;
			//			setStyleByDefault();
			reDraw();
		}
		...
		{
			if(this._bgColor2 == value) return;
		...
		{
			if(this._isNextDraw == value) return;
		...
		{
			if(this.bgRotaion == value) return;
		...
		private function setObjByVars(resObj:Object,newObj:Object,isStrict:Boolean=true):Object
		{
