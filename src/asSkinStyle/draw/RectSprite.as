...
package asSkinStyle.draw
{
	 ...
	 */
	public class RectSprite extends SpriteDraw implements IRectDraw
	{
		public function RectSprite(uiName:String="draw")
		{
			super(uiName);
		}
		...
		override protected function draw():void
		{
			...
			super.draw();
//			var pd:int = 5;
//			var rc:Rectangle = new Rectangle(20, 20, 60, 60);
//			var rc:Rectangle = new Rectangle((width*0.5-pd),(height*0.5-pd),pd,pd);
...
//			}
		...
		{
			return _height + borderTop + borderBottom;
		}*/
	}
}