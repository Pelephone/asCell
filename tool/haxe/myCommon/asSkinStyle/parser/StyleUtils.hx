...
class StyleUtils
{
	 ...
	 * 分隔父项样式与子项样式的分隔符
	 */
	private static var SEPARATOR_CHILD:String = " ";
	/**
	 * 通过空格语法获取项
	 * @param spName
	 * @return 
	 */
	public static function getCssBySplitName(spName:String,cpe:StyleComposite):StyleComposite
	{
		if(spName.indexOf(SEPARATOR_CHILD)<0)
		{
			return cpe.getChildByName(spName);
		}
		var arr:Array<String> = spName.split(SEPARATOR_CHILD);
	 ...
	 * @return 			返回改变属性后的原对象
	 */
	public static function setObjByVars(resObj:Object,newObj:Object
	 ...
	 * @return 不生成的属性名
	 */
	public static function xmlCreateObject(xml:Object,toVars:Object=null,filterAttrs:Array=null):Object
	{
