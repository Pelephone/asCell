...
package debuger
{
	 ...
	 */
	public class UIReflectCode2
	{
		/**
		 * 单例
		 */
		private static var instance:UIReflectCode2;
		/**
		 * 获取单例
		 */
		public static function getInstance():UIReflectCode2
		{
			if(!instance)
				instance = new UIReflectCode2();
			
			return instance;
		}
		
		public function UIReflectCode2()
		{
...
//			tmpImportArr.push("utils.LinkageRefl");
		...
		private static const fullPackLang:String = "package {package}\n" +
			...
			"" +
			"		public function {clsname}(viewSkin:Sprite=null)\n" +
			"		{\n" +
			"			if(!viewSkin)\n" +
			"				viewSkin = this;\n" +
			"			skin = viewSkin;\n" +
...
//				var val:String = parentKo.attrName;
...
//			pushImportCode(qname);
			...
			keyObj.tmpVarName = getAttrName(obj,attrName,parentStr);
			var typeStr:String = changeTypeStr2(obj);
			var newStr:String = changeTypeNewStr(obj,tname);
			
			var langStr:String = (parentStr == ROOT_STR)?newLang:varNewLang;
			var varStr:String = langStr.replace("{name}",keyObj.attrName);
		...
		private function reflRegObj(obj:Object,beNewObj:Object,pathStr:String,type:int=0):KeyObject
		{
			...
			var langStr:String = (parentKo.pathKey == ROOT_STR)?newLang:varNewLang;
			var varStr:String = langStr.replace("{name}",keyObj.attrName);
...
/*			if(keyObj.target is TextFormat && parentKo.target is TextField)
		...
		private function doSetCode(keyObj:KeyObject,parentStr:String,attrName:Object,val:String,type:int=0):KeyObject
		{
			...
			if(type==0)
			{
				if(parentStr == ROOT_STR && attrName == val)
					return keyObj;
		 ...
		 * @return 
		 */
		private static function getAttrName(obj:Object,atName:String=null,parentStr:String=null):String
		{
			if(parentStr == ROOT_STR)
				return atName;
