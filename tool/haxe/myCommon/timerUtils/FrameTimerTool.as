...
package TimerUtils
{
	 ...
	 * Pelephone
	 */
	public class FrameTimerTool extends TimerToolBase implements ITimerTool
	{
		/**
		...
		public function FrameTimerTool()
		{
			super();
			timerInfMap = {};
		}
...
//			tInf.frameRate = frameRate;
			tInf.delay = delay;
			tInf.timer = new FrameTimer(delay);
...
//			var fr:int = 1000/Timer(e.target).delay;
			var tInf:TimerInfo = timerInfMap[FrameTimer(e.target).delay];
...
class TimerInfo
{
	...
	public var renderLs:Vector.<IEnterRender> = new Vector.<IEnterRender>();*/
}